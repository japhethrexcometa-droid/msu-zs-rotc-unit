...
CREATE POLICY "settings_update_admin" ON public.system_settings FOR UPDATE USING (check_access()) WITH CHECK (check_access());
CREATE POLICY "settings_insert_admin" ON public.system_settings FOR INSERT WITH CHECK (check_access());
